...
public class BufferBuilderTest {
    ...
    public void mergeBufferVODEvents() {
        ...
        verify(mockProcessor, times(1)).createEventPlayOnDemand("c1", "s1", playOptions, customParameters, null);
        verify(mockProcessor, times(1)).createEventPlayOnDemand("c2", "s2", playOptions, customParameters, null);
